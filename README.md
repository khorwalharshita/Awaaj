...
Built entirely using Jetpack Compose, ensuring smooth transitions, responsive layouts, and a modern design style.

📱 Modular & Scalable Architecture
Clean screen separation, reusable components, and easy-to-maintain code structure.

🔄 Seamless Navigation
Uses Compose Navigation to switch between learning screens, dictionary, quiz, and other features effortlessly.
...
Choose the Awaaj project folder
